...
class DonateCopyWidget extends StatefulWidget {
  const DonateCopyWidget({Key key}) : super(key: key);

  @override
  _DonateCopyWidgetState createState() => _DonateCopyWidgetState();
}

class _DonateCopyWidgetState extends State<DonateCopyWidget> {
