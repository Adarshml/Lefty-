...
class CreateAccountUserCopyWidget extends StatefulWidget {
  const CreateAccountUserCopyWidget({Key key}) : super(key: key);

  @override
  _CreateAccountUserCopyWidgetState createState() =>
      _CreateAccountUserCopyWidgetState();
}

class _CreateAccountUserCopyWidgetState
    extends State<CreateAccountUserCopyWidget> {
