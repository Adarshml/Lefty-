...
class MylistdetailsCopyWidget extends StatefulWidget {
  const MylistdetailsCopyWidget({
    Key key,
    this.donateDetails,
    this.dmap,
  }) : super(key: key);
  ...
  @override
  _MylistdetailsCopyWidgetState createState() =>
      _MylistdetailsCopyWidgetState();
}

class _MylistdetailsCopyWidgetState extends State<MylistdetailsCopyWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DonateRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final mylistdetailsCopyDonateRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
            ...
            title: StreamBuilder<List<DonateRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                final textDonateRecord = textDonateRecordList.isNotEmpty
                    ...
                    : null;
                return Text(
                  mylistdetailsCopyDonateRecord.foodName,
                            ...
                            builder: (context, snapshot) {
                              ...
                              return Image.network(
                                valueOrDefault<String>(
                                  mylistdetailsCopyDonateRecord.foodimageUrl,
                              ...
                              children: [
                                StreamBuilder<List<DonateRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return Text(
                                      valueOrDefault<String>(
                                        mylistdetailsCopyDonateRecord.status,
                                        'Active',
                                      ),
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    final textDonateRecord =
                                        textDonateRecordList.isNotEmpty
                                            ...
                                            : null;
                                    return Text(
                                      mylistdetailsCopyDonateRecord.description,
                                      style: FlutterFlowTheme.of(context)
                                          .subtitle1
                                          .override(
                                            fontFamily: 'Product Sans',
                              ...
                              builder: (context, snapshot) {
                                ...
                                final textDonateRecord =
                                    textDonateRecordList.isNotEmpty
                                        ...
                                        : null;
                                return Text(
                                  '${mylistdetailsCopyDonateRecord.initialquantity.toString()}pcs',
                                  style: FlutterFlowTheme.of(context)
                                      .subtitle1
                                      .override(
                                        fontFamily: 'Product Sans',
                                  ...
                                  return FlutterFlowGoogleMap(
                                    ...
                                    initialLocation: googleMapsCenter ??=
                                        mylistdetailsCopyDonateRecord
                                            .donorLocation,
                                    markers: [
                                      if (mylistdetailsCopyDonateRecord != null)
                                        FlutterFlowMarker(
                                          mylistdetailsCopyDonateRecord
                                              .reference.path,
                                          mylistdetailsCopyDonateRecord
                                ...
                                StreamBuilder<List<DonateRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return InkWell(
                                      ...
                                      child: Text(
                                        mylistdetailsCopyDonateRecord.claimedby,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyText1
                                            .override(
                                              fontFamily: 'Product Sans',
